...
// Forzar que el CPT 'curso' sea editable con Elementor
function anima_enable_elementor_for_curso( $post_type ) {
  $post_type[] = 'curso';
  return $post_type;
}
add_filter( 'elementor_pro/utils/get_public_post_types', 'anima_enable_elementor_for_curso' );
