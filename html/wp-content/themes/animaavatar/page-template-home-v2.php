...
$img_ai = "https://picsum.photos/seed/ailab3/800/600";
            ...
            <a href="#ai-oracle-section" class="scroll-indicator">
                ...
                <svg class="scroll-icon" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2" fill="none">
            ...
            <div class="oracle-wrapper text-center">
                ...
                <div class="crt-console-output">
                    <div class="console-screen">
                        <span id="oracle-cursor_v11">█</span> <span id="oracle-text_v11" class="console-text">ESPERANDO
                            INPUT... CONECTA CON LA IA CENTRAL.</span>
                    </div>
                </div>
        ...
        <section id="the-four-sectors" class="section-pillars">
            ...
            <div class="pillars-grid-container">
                ...
                <a href="#" class="pillar-card">
                    <div class="card-bg-layer" style="background-image: url('<?php echo esc_url($img_live); ?>');">
                    </div>
                    <div class="card-glass-layer">
                        ...
                        <p class="card-description">El taller de dioses. Diseña tu avatar hiperrealista con captura
                            facial en tiempo real. Tu rostro, tu alma digital.</p>
                        <div class="card-footer-action">EJECUTAR PROTOCOLO ></div>
                    </div>
                </a>

                <a href="#" class="pillar-card">
                    <div class="card-bg-layer" style="background-image: url('<?php echo esc_url($img_world); ?>');">
                    </div>
                    <div class="card-glass-layer">
                        <div class="card-icon-box">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                        ...
                        <p class="card-description">La red social encarnada. Salas inmersivas, eventos en vivo y el
                            Parque Central. Conecta en el espacio 3D.</p>
                        <div class="card-footer-action">ENTRAR A LA RED ></div>
                    </div>
                </a>

                <a href="<?php echo home_url('/academy/'); ?>" class="pillar-card">
                    <div class="card-bg-layer" style="background-image: url('<?php echo esc_url($img_academy); ?>');">
                    </div>
                    <div class="card-glass-layer">
                        <div class="card-icon-box">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                        ...
                        <p class="card-description">Sube de nivel. Domina Unreal Engine 5, blueprints y animación. Gana
                            XP y desbloquea tu potencial.</p>
                    ...
                    <div class="card-glass-layer">
                        <div class="card-icon-box">
                            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none"
                                stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                                <path
                                    d="M9.5 2A2.5 2.5 0 0 1 12 4.5v15a2.5 2.5 0 0 1-4.96.44 2.5 2.5 0 0 1-2.96-3.08 3 3 0 0 1-.34-5.55 2.5 2.5 0 0 1 1.32-4.24 2.5 2.5 0 0 1 1.98-3A2.5 2.5 0 0 1 9.5 2Z">
                                </path>
                                <path
                                    d="M14.5 2A2.5 2.5 0 0 0 12 4.5v15a2.5 2.5 0 0 0 4.96.44 2.5 2.5 0 0 0 2.96-3.08 3 3 0 0 0 .34-5.55 2.5 2.5 0 0 0-1.32-4.24 2.5 2.5 0 0 0-1.98-3A2.5 2.5 0 0 0 14.5 2Z">
                                </path>
                        ...
                        <p class="card-description">Tu asistente neuronal. Genera biografías complejas e imágenes
                            conceptuales usando Créditos y DALL-E.</p>
...
<style>
    ...
    .overlay-scanline {
        position: absolute;
        inset: 0;
        background: repeating-linear-gradient(0deg, transparent 0px, rgba(0, 0, 0, 0.3) 1px, transparent 3px);
        pointer-events: none;
    ...
    .overlay-vignette {
        position: absolute;
        inset: 0;
        background: radial-gradient(circle at center, transparent 20%, var(--bg-void) 100%);
        z-index: 3;
    }
    ...
    .p-light {
        ...
        border-radius: 50%;
        opacity: 0;
        animation: particleFloatUp 12s infinite linear;
    }
    ...
    .cyber-glitch::before {
        ...
        animation: glitch-shift-1 3s infinite steps(1) alternate;
    ...
    .cyber-glitch::after {
        ...
        animation: glitch-shift-2 2.5s infinite steps(1) alternate-reverse;
        transform: translate(4px, 0);
    }
    ...
    .scroll-icon {
        width: 24px;
        height: 24px;
        animation: rubberBandArrow 2s infinite;
    }

    @keyframes rubberBandArrow {
    ...
    .outer-ring {
        ...
        animation: spinVortex 5s linear infinite;
    }
    ...
    .inner-ring {
        ...
        animation: spinVortex 7s linear infinite reverse;
    }

    .vortex-core {
        width: 55%;
        height: 55%;
        background: radial-gradient(circle, rgba(0, 240, 255, 0.8) 0%, rgba(188, 19, 254, 0.4) 60%, transparent 100%);
        border-radius: 50%;
        position: relative;
        overflow: hidden;
    ...
    .data-stream-texture {
        position: absolute;
        inset: -100%;
        background: repeating-conic-gradient(from 0deg, transparent 0deg, rgba(255, 255, 255, 0.3) 15deg, transparent 30deg);
        animation: rotateData 4s linear infinite;
        mix-blend-mode: overlay;
    }

    .ai-vortex-visualizer.processing .outer-ring {
        animation-duration: 1.5s;
        border-color: #fff;
        box-shadow: 0 0 30px var(--neon-cyan);
    }

    .ai-vortex-visualizer.processing .inner-ring {
        animation-duration: 2s;
        border-color: #fff;
    }

    .ai-vortex-visualizer.processing .vortex-core {
        box-shadow: 0 0 80px #fff, 0 0 120px var(--neon-pink);
    ...
    .console-screen {
        ...
        border: 1px solid var(--glass-border-pro);
        border-radius: 8px;
        padding: 25px;
        min-height: 110px;
        text-align: left;
    ...
    .section-pillars {
        padding: 140px 5%;
        background: linear-gradient(180deg, var(--bg-void) 0%, var(--bg-panel) 100%);
        position: relative;
        z-index: 5;
    }
    ...
    .pillar-card:nth-child(1) {
        --theme-color: var(--energy-pink);
    }

    .pillar-card:nth-child(2) {
        --theme-color: var(--energy-cyan);
    }

    .pillar-card:nth-child(3) {
        --theme-color: var(--energy-green);
    }

    .pillar-card:nth-child(4) {
        --theme-color: var(--energy-gold);
    }
    ...
    .pillar-card {
        ...
        /* Borde de Energía */
        box-shadow: 0 0 15px rgba(0, 0, 0, 0.8), 0 0 20px var(--theme-color), inset 0 0 30px rgba(0, 0, 0, 0.8);
        /* Resplandor */
    ...
    .card-glass-layer {
        ...
        box-shadow: 0 -10px 20px var(--theme-color);
        /* Luz superior */
        /* Textura de circuito */
    ...
    .mini-tag {
        ...
        border-radius: 2px;
        box-shadow: 0 0 8px var(--theme-color) inset;
        text-transform: uppercase;
        letter-spacing: 1px;
        font-family: var(--font-ui);
    }
    ...
    .card-footer-action {
        ...
        background: linear-gradient(90deg, rgba(var(--theme-color), 0.2) 0%, transparent 100%);
        width: 100%;
        display: block;
    }
    ...
    .pillar-card:hover {
        ...
        box-shadow: 0 20px 50px rgba(0, 0, 0, 0.8), 0 0 40px var(--theme-color), inset 0 0 50px var(--theme-color);
        z-index: 10;
    }

    .pillar-card:hover .card-bg-layer {
        filter: grayscale(0%) contrast(1.3) brightness(1.1);
        transform: scale(1.1);
        height: 65%;
    }

    .pillar-card:hover .card-glass-layer {
        background: rgba(10, 14, 20, 0.95);
        border-top-width: 4px;
        box-shadow: 0 -15px 30px var(--theme-color);
    }

    .pillar-card:hover .card-icon-box svg {
        transform: scale(1.2) rotate(5deg);
        filter: drop-shadow(0 0 15px var(--theme-color));
    }

    .pillar-card:hover .mini-tag {
        background: var(--theme-color);
        color: #000;
        box-shadow: 0 0 15px var(--theme-color);
    }

    .pillar-card:hover .card-footer-action {
        letter-spacing: 4px;
        background: linear-gradient(90deg, rgba(var(--theme-color), 0.6) 0%, transparent 100%);
    }
    ...
    .solid-pink {
        background: linear-gradient(135deg, var(--neon-pink), #9c12d4);
        box-shadow: 0 10px 30px rgba(188, 19, 254, 0.3);
    }

    .solid-pink:hover {
        transform: translateY(-3px);
        box-shadow: 0 20px 50px rgba(188, 19, 254, 0.5);
    }

    .solid-pink:hover .btn-glitch {
        opacity: 0.2;
        animation: glitchBtn 0.3s linear infinite;
    }
    ...
    .outline-cyan:hover {
        ...
        box-shadow: inset 0 0 0 2px var(--neon-cyan), 0 0 30px var(--neon-cyan);
        color: #fff;
        transform: translateY(-2px);
    }

    .outline-cyan .dashicons {
        font-size: 1.3rem;
    }
